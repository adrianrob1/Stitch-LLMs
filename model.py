...
def top_p_filtering(
    ...
    Args:
        ...
        min_tokens_to_keep (`int`, *optional*, defaults to 1):
            Minimum number of tokens we keep per batch example in the output.
...
class GPT(nn.Module):
    ...
    @torch.no_grad()
    def generate(self, idx, max_new_tokens, decode, temperature=1.0, top_k=None, top_p=None):
        """
        ...
        for _ in range(max_new_tokens):
            ...
            if top_k is not None:
                ...
                top_p_filtering(logits, top_p=top_p)
